...
- Semester-aware outlooks based on the latest 14 completed operating days, with D1-backed closure periods that pause projections; recorded expenses reduce the current balance once but are not projected to repeat

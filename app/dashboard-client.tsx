...
export default function DashboardClient({ displayName }: { displayName: string }) {
  ...
  const refreshAmexAudit = async () => {
    ...
    try {
      ...
      await load();
      toast.success(result.audit.awaitingReview ? "Balance refreshed. Review Amex transactions and apply expenses to complete the audit." : "Amex balance audited.");

...
type LedgerData = {
  ...
  cardAudit: { expectedBalanceCents: number; usesAmexTransfers: boolean; ledgerMovementCents: number; otherDepositCents: number; adjustmentCents: number; cardOutflowCents: number; hasBaseline: boolean; lastAudit: CardAudit | null; history: CardAudit[]; adjustments: CardAdjustment[] };
...
export default function DashboardClient({ displayName }: { displayName: string }) {
  ...
  const review = async (classification: "snack_bar" | "personal" | "card_transfer" | "card_deposit") => {

  ...
  try {
    ...
    return Response.json({
      ...
      cardAudit: {
        ...
        untransferredVenmoCents: cardSnapshot.untransferredVenmoCents,
        ...
        awaitingReview: rows.some((row) => row.classification === "pending" && (row.source === "amex" || row.source === "venmo")) || pendingCardOutflows.length > 0,
        awaitingTransfer: cardSnapshot.untransferredVenmoCents > 0,
